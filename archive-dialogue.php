<?php
/**
 * カスタム投稿名「Interview」（post_type: 'dialogue'）のアーカイブページを表示するテンプレートです。
 *
 * @package DESIGN:D
 */
get_header(); ?>

<section id="aboutus__works-archive" class="dflt">
	<div class="section_inner two-column">
		<div class="first_block fix_container">
			<div class="fix_inner">
				<h3 class="font-en deco_w-dot txt_split anim-trigger tip-trigger" data-text="対談">Dialogue <sup class="total_post_count">(<?php echo wp_count_posts('dialogue')->publish; ?>)</sup></h3>
			</div>
		</div>
