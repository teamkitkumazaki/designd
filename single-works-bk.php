			...
			<div class="article_contents">
				...
				<?php foreach ($article as $d):?>
					<div class="article_item">
						...
						<div class="article_text two-column anim-trigger">
							<?php if ($d['title_jp']):?>
							<hgroup id="section<?= $contents_length;?>" class="first_block">
								<div class="sticky_inner">
									<p class="sholder ttl_en"><?= $d['title_en'];?></p>
							...
							<div class="article_description contents_block text-block">
						...
						<?php if ($d['article_image']):?>
							<div class="img_wrap anim-trigger-fade">
								<?php
									$img_medium = wp_get_attachment_image_src($d['article_image'], 'medium');
