...
<?php
	...
	$main_visual = SCF::get('main_visual',$post_id);
	$main_visual_url = wp_get_attachment_image_src($main_visual, 'full');
	$main_visual_url_sp = wp_get_attachment_image_src($main_visual, 'medium_large');
	...
	$article_title_inner = SCF::get('article_title_inner',$post_id);
...
<article id="dialogueDetail" class="page-dialogue-detail single-page">
	<section id="articleContent" class="section-dialogue-header dflt maincontents">
		<div class="section_inner">
			<?php if ($article_title_inner):?>
				<h1 class="dialogue_ttl font-sub anim-trigger-fade" style="white-space: pre-line;"><?= $article_title_inner; ?></h1>
			<?php else: ?>
