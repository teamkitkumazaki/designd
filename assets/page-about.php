...
<section id="aboutus__msg" class="dflt">
	...
	<div class="section_inner two-column dark">
		...
		<div class="contents_block font-sub">
			<div class="block_inner inner1">
				<h4 class="anim-trigger"><span>私たちの強み</span></h4>
			...
			<div class="block_inner inner2">
				...
				<dl class="anim-trigger" data-trigger-timing="100">
					...
					<dd>
						<p class="font-sub" data-trigger-timing="100">
		...
		<div class="contents_block">
			<div class="member_container">
				...
				<?php
					...
					$client_logo_url = wp_get_attachment_image_src($client_logo, 'medium');
					/* カテゴリー */
					...
					<div class="member_detail accordion-parent">
						...
						<div class="detail_lower">
							<div class="sns_wrap font-en">
								...
								<?php if ($sns_facebook):?><a target="_blank" href="<?=$sns_facebook;?>">Fb</a><?php endif; ?>
								<?php if ($sns_instagram):?><a target="_blank" href="<?=$sns_instagram;?>">Ig</a><?php endif; ?>
							</div>
							<?php if ($profile_txt):?>
